      ...
      <div className='hSection left'>
        ...
        <motion.div variants={awardVariants} initial='initial' animate='animate' className='awards'>
          ...
          <motion.p variants={awardVariants}>
            A top-rated web developer crafts high-performance, visually stunning websites with seamless user
            experiences. Expert in modern frameworks and best practices, they deliver scalable and efficient solutions.
          </motion.p>
          <motion.div variants={awardVariants} className='awardList'>
            <motion.img src='/award1.png' variants={awardVariants}></motion.img>
            <motion.img src='/award2.png' variants={awardVariants}></motion.img>
            <motion.img src='/award3.png' variants={awardVariants}></motion.img>
          </motion.div>
        </motion.div>
        {/* scroll svg */}
        <motion.a
